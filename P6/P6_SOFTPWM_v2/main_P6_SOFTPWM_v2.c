...
Ademas, se mostrara duty. 
Mencionar que en esta version se obtiene PWM a traves de un temporizador y un pin de salida.

A partir de este punto se permite la interrupcion de los pulsadores S3, S4 y S6:
* pulsador S3 -> parar/reanudar cronometro
* pulsador S4 -> cambiar la gestion de duty de modo que se obtenga a partir de la potencia o se modifique por UART
