...
{   
    ...
    if(!flag_DUTY){ //Si flag_DUTY==0 se obtiene duty a partir de la potencia
        duty = (Poten_media/1023) * (DUTY_MAX - DUTY_MIN) + DUTY_MIN; // Obtener duty a partir de la potencia
